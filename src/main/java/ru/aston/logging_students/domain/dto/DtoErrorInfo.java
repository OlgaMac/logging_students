...
public class DtoErrorInfo {
    ...
    @Schema(description = "Класс ошибки", example = "ru.aston.logging_students.domain.exception.EntityNotFoundException")
    private String exception;

    @Schema(description = "Сообщение ошибки", example = "Student with Id: 1 not found")
